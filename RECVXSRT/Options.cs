...
namespace RECVXSRT
{
    public struct Options
    {
        ...
        public void GetOptions()
        {
            ...
            RegistryKey optionsKey = Registry.CurrentUser.CreateSubKey("SOFTWARE\\re-cvx-srt", false);
            ...
            if (RegistryHelper.GetBoolValue(optionsKey, "NoEnemyHealth", false))
                Flags |= ProgramFlags.NoEnemyHealth;
            else
                Flags &= ~ProgramFlags.NoEnemyHealth;
        ...
        {
            // Initialize registry key.
            RegistryKey optionsKey = Registry.CurrentUser.CreateSubKey("SOFTWARE\\re-cvx-srt", true);
            ...
            if ((Flags & ProgramFlags.NoEnemyHealth) == ProgramFlags.NoEnemyHealth)
                optionsKey.SetValue("NoEnemyHealth", 1, RegistryValueKind.DWord);
            else
                optionsKey.SetValue("NoEnemyHealth", 0, RegistryValueKind.DWord);
