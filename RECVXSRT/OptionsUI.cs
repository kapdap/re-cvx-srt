...
namespace RECVXSRT
{
    public partial class OptionsUI : Form
    {
        ...
        public OptionsUI()
        {
            ...
            noEnemyHealthCheckBox.Checked = (Program.programSpecialOptions.Flags & ProgramFlags.NoEnemyHealth) == ProgramFlags.NoEnemyHealth;
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            if (noEnemyHealthCheckBox.Checked && (Program.programSpecialOptions.Flags & ProgramFlags.NoEnemyHealth) != ProgramFlags.NoEnemyHealth)
                Program.programSpecialOptions.Flags |= ProgramFlags.NoEnemyHealth;
            else if (!noEnemyHealthCheckBox.Checked && (Program.programSpecialOptions.Flags & ProgramFlags.NoEnemyHealth) == ProgramFlags.NoEnemyHealth)
                Program.programSpecialOptions.Flags &= ~ProgramFlags.NoEnemyHealth;
